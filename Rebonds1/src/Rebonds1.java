...
public class Rebonds1 {
	...
	case 1:
		...
		System.out.printf("HAUTEUR aprés "+ nbr + " Rebonds est de :%.2f ", h0 );
		System.out.println();
		...
		case 2:
			...
			System.out.println("Nombre de rebonds est de " + nbr + " pour aller de " + hauteur + " à la hauteur de fin " + h_fin);
